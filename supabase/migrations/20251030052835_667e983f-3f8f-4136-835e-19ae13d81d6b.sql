-- Update generate_seat_number function to remove payment checks
...
-- Also remove the touch_registration_on_payment trigger since we don't have payments anymore
DROP FUNCTION IF EXISTS public.touch_registration_on_payment() CASCADE;