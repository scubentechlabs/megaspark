...
export default function Admin() {
  ...
  const printReport = () => {
    ...
    if (printWindow) {
      ...
      toast({
        title: "Print Ready",
        description: `Printing ${data.length} registrations`,
      });
    } else {
      toast({
        title: "Error",
                  ...
                  <CardContent className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {reportType === "exam-date" && (
                        <div className="space-y-2">
                          <Label htmlFor="exam-date-filter">Exam Date</Label>
                          <select
                            id="exam-date-filter"
                      ...
                      {reportType === "room" && (
                        <div className="space-y-2">
                          <Label htmlFor="room-filter">Room Number</Label>
                          <select
                            id="room-filter"
                            value={selectedRoom}
                      ...
                      {reportType === "school" && (
                        <div className="space-y-2">
                          <Label htmlFor="school-filter">School Name</Label>
                          <select
                            id="school-filter"
                    ...
                    <div className="bg-muted/50 p-4 rounded-md">
                      <p className="text-sm font-semibold mb-2">Report Summary</p>
                      <p className="text-sm text-muted-foreground">
                        Total Records: <span className="font-semibold text-foreground">{getFilteredReportData().length}</span>
                      </p>
                    </div>
